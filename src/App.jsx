  ...
  const PracticeView = () => {
    ...
    if (!current) return (
      <div style={{ textAlign: "center", padding: "60px 0", color: C.muted }}>
        ...
        <div style={{ fontFamily: "'Nanum Gothic', sans-serif", marginBottom: 16 }}>오늘 풀 문장이 없어요!</div>
      ...
      <div onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
        ...
        <div style={{ ...card, padding: "14px 18px", marginBottom: 14 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", marginTop: 8 }}>
            ...
            {current.nextReviewDate === null && <span style={{ fontSize: 10, background: C.orangeLight, color: C.orange, borderRadius: 8, padding: "2px 8px", fontFamily: "'Nanum Gothic', sans-serif", fontWeight: 600 }}>새 문장</span>}
          ...
          <div style={card}>
            ...
            {evalResult.grade === "하" && (
              <div style={{ background: "#fff5f5", border: "1.5px solid #fca5a5", borderRadius: 12, padding: "14px 16px", marginBottom: 14 }}>
                <div style={{ fontWeight: 700, color: "#991b1b", fontSize: 14, fontFamily: "'Nanum Gothic', sans-serif", marginBottom: 4 }}>🔄 재도전이 필요해요!</div>
                <div style={{ fontSize: 13, color: "#7f1d1d", fontFamily: "'Nanum Gothic', sans-serif", lineHeight: 1.6 }}>내일 다시 출제돼요.</div>
              </div>
            )}
